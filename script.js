...
function layoutStage(){
  ...
  // batasi rasio lebar:tinggi maksimal, biar topbar & drum kit
  // gak ikut melar horizontal pas dibuka di jendela browser yang
  // sangat lebar (laptop/monitor). Sisa ruang di kiri-kanan
  // dibiarkan kosong (letterbox) daripada tampilan jadi gepeng.
  const maxRatio = 2.0; // lebar maksimal 2x tinggi
  let stageW = canvasW;
  let stageH = canvasH;
  if(stageW / stageH > maxRatio){
    stageW = stageH * maxRatio;
  }
